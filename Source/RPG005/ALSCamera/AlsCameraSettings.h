...
struct RPG005_API FAlsFirstPersonCameraSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsTraceDistanceSmoothingSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsThirdPersonCameraSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsCameraLagSubsteppingSettings
{
	GENERATED_BODY()
...
class RPG005_API UAlsCameraSettings : public UDataAsset
{
	GENERATED_BODY()
