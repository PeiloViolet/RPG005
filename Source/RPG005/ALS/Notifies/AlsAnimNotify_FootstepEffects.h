...
struct RPG005_API FAlsFootstepEffectSettings
{
	GENERATED_BODY()
...
class RPG005_API UAlsFootstepEffectsSettings : public UDataAsset
{
	GENERATED_BODY()
...
class RPG005_API UAlsAnimNotify_FootstepEffects : public UAnimNotify
{
	GENERATED_BODY()
