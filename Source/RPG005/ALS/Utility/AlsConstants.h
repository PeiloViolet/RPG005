...
class RPG005_API UAlsConstants : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "RPG|RPG Constants")
	static const FName& ForwardMovementCurve();
};
...
inline const FName& UAlsConstants::ForwardMovementCurve()
{
	static const FName Name{TEXT("ForwardMovement")};
	return Name;
}
