...
struct RPG005_API FAlsRigUnit_MathBase : public FRigUnit
{
	GENERATED_BODY()
};

USTRUCT(Meta = (Abstract, NodeColor = "0 0.35 1.0"))
struct RPG005_API FAlsRigUnit_HighLevelBase : public FRigUnitMutable
{
	GENERATED_BODY()
};

USTRUCT(Meta = (Abstract, NodeColor = "0.25 0.05 0.05"))
struct RPG005_API FAlsRigUnit_SimulationBase : public FRigUnit
{
	GENERATED_BODY()
};
...
struct RPG005_API FAlsRigUnit_CalculatePoleVector : public FAlsRigUnit_MathBase
{
	GENERATED_BODY()
...
struct RPG005_API FAlsRigUnit_ExponentialDecayVector : public FAlsRigUnit_SimulationBase
{
	GENERATED_BODY()
...
struct RPG005_API FAlsRigUnit_HandIkRetargeting : public FAlsRigUnit_HighLevelBase
{
	GENERATED_BODY()
