...
void UAlsAnimationInstance::RefreshStrideBlendAmount()
{
	...
	const auto AlsSpeed{LocomotionState.Speed / LocomotionState.Scale};

	const auto StandingStrideBlend{
		FMath::Lerp(Settings->Grounded.StrideBlendAmountWalkCurve->GetFloatValue(AlsSpeed),
		            Settings->Grounded.StrideBlendAmountRunCurve->GetFloatValue(AlsSpeed),
	...
	GroundedState.StrideBlendAmount = FMath::Lerp(StandingStrideBlend,
	                                              Settings->Grounded.StrideBlendAmountWalkCurve->GetFloatValue(AlsSpeed),
