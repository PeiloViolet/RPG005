...
class RPG005_API AAlsCharacter : public AACFCharacter
{
	GENERATED_BODY()
...
protected:
	...
	//当处于VelocityDirection模式时，在不移动的时候，旋转角色到最后的Yaw方向;(对非正向Rootmotion有影响)
	UPROPERTY(Replicated, EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|RPGCharacter")
	bool RotateToLastTargetYawAngleWhenNotMoving{false};
