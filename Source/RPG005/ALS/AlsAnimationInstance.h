...
UCLASS()
class RPG005_API UAlsAnimationInstance : public UACFRiderAnimInstance
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings|Sprint", Transient, Meta = (AllowPrivateAccess))
	float AnimTimeThreshold = 0.5f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings|Sprint", Transient, Meta = (AllowPrivateAccess))
	float RelativeAccelerationAmountRate = 1.0f;
