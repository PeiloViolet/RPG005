...
struct RPG005_API FAlsLookTowardsInputState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsLookTowardsCameraState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsSpineRotationState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsViewAnimationState
{
	GENERATED_BODY()
