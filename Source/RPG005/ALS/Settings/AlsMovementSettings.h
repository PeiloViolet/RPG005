...
#include "RPG005/ALS/Utility/AlsGameplayTags.h"
...
struct RPG005_API FAlsMovementGaitSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsMovementStanceSettings
{
	GENERATED_BODY()
...
class RPG005_API UAlsMovementSettings : public UDataAsset
{
	GENERATED_BODY()
