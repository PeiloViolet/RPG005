...
struct RPG005_API FAlsMantlingParameters
{
	GENERATED_BODY()
...
class RPG005_API UAlsMantlingSettings : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsMantlingTraceSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005_API FAlsGeneralMantlingSettings
{
	GENERATED_BODY()
