...
#include "RPG005/ALS/Nodes/AlsAnimNode_GameplayTagsBlend.h"
#include "AlsAnimGraphNode_GameplayTagsBlend.generated.h"

UCLASS()
class RPG005EDITOR_API UAlsAnimGraphNode_GameplayTagsBlend : public UAnimGraphNode_BlendListBase
{
	GENERATED_BODY()
