...
struct RPG005EDITOR_API FAlsAnimationCurveKey
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct RPG005EDITOR_API FAlsAnimationCurve
{
	GENERATED_BODY()
...
class RPG005EDITOR_API UAlsAnimationModifier_CreateCurves : public UAnimationModifier
{
	GENERATED_BODY()
